...
export function GalleryCommentSheet({ category, index, onClose, onCommentAdded, onCommentDeleted, highlightCommentId }: Props) {
  ...
  const renderCommentItem = (c: GalleryComment, isReply = false, replyRoot?: GalleryComment) => {
    ...
    const displayName = c.author_username
      ? c.author_username
      : c.author_email
                ...
                <>
                  ...
                  >
                    <svg
                      ...
                      height="13"
                      viewBox="0 0 24 24"
                      fill={likeState.liked ? "#E02424" : "none"}
                      stroke={likeState.liked ? "#E02424" : "currentColor"}
                      strokeWidth="2.2"
                      strokeLinecap="round"
  ...
  return (
    <CommentSheetFrame title="댓글" onClose={onClose}>
      ...
      <div className="gallery-sheet-input-row">
        ...
        />
        <button
          className={`gallery-sheet-submit${input.trim() ? " active" : ""}`}

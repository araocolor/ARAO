...
## 📌 커밋별 작업 요약 (2026-04-03 ~ 2026-04-04)

| 날짜 | 커밋 | 요약 |
|------|------|------|
| 2026-04-04 | `3ba11ee` | 커뮤니티 새글 FAB에서 발생한 hydration mismatch 방지 처리 |
| 2026-04-03 | `1d06890` | 글작성/수정 상단에 게시판 선택 옵션 추가, 리스트 제목 앞 순번 제거 |
| 2026-04-03 | `ec37ae3` | 새글 FAB를 연필 아이콘/좌측 하단 배치로 전환, 색상 톤 조정 |
| 2026-04-03 | `5ff1e93` | 리스트에서 내 글(`isAuthor`)에 5% 회색 배경 적용, 하단 작성 버튼 고정 |
| 2026-04-03 | `14114c1` | 본문 작성자 메타 개선(아이콘/날짜/조회수), 댓글 대댓글(스레드) 기능 추가 |
| 2026-04-03 | `e2118d7` | 헤더 검색 아이콘의 원형 배경 제거 및 아이콘 비율 조정 |
| 2026-04-03 | `51b27d0` | 커뮤니티 검색 시트 UX 도입, 시트 내 검색 결과 표시, 서버 검색 성능 최적화 |
| 2026-04-03 | `bbb05f9` | 커뮤니티 흐름 안정화(삭제/저장/캐시/경로 보정), 읽은 글 제목 +1px 적용 |
